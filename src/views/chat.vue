  ...
  <div class="h-100 w-100">
    ...
    >
      ...
      >
        ...
        >
          <video :srcObject.prop="stream" autoplay class="video"></video>
        </div>
        <button @click="peer()">
          peer
        </button>
      ...
      >
        <img
          :src="$store.getters['api'] + '/profiles/' + chattingUser.image"
          alt=""
          width="60"
          height="60"
      ...
      <div
        ...
        style="flex-direction: column; overflow: auto"
      >
        <div v-for="(mesage, i) in mesages" :key="i" class="p-2 message">
          <div class="d-flex">
            <img
              :src="$store.getters['api'] + '/profiles/' + mesage.sender.image"
              height="50"
              width="50"
              alt="Profile image"
            ...
            <div class="text-break" style="white-space: pre-wrap">
              <div class="mb-1 d-flex">
                ...
                <div class="text-muted mt-0" style="font-size: 15px">
  ...
  methods: {
    emit() {
      if (this.message != "") {
        ...
        this.axios
          .post(
            this.$store.getters["api"] + "/messages/add/" + this.chatId,
            {
    ...
    peer() {
      navigator.mediaDevices
        ...
        .then((stream) => {
          ...
          var peer = new Peer(undefined, this.$store.getters["peerObject"]);
